// Provisional 18-type effectiveness chart (mainline-derived).
//
// Only non-neutral matchups are listed: 2 = super effective, 0.5 = not very
// effective, 0 = immune. Everything else is 1. Flagged provisional via
// ASSUMPTIONS.typeChart.
