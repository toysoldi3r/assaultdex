...
CREATE TABLE "new_Pokemon" (
    ...
    "movepool" TEXT NOT NULL DEFAULT '[]',
    "moves" TEXT NOT NULL,
...
INSERT INTO "new_Pokemon" ("abilities", "baseStats", "createdAt", "dataVersion", "externalId", "id", "moves", "name", "normalizationVersion", "provider", "retrievedAt", "slug", "types", "updateStatus", "updatedAt") SELECT "abilities", "baseStats", "createdAt", "dataVersion", "externalId", "id", "moves", "name", "normalizationVersion", "provider", "retrievedAt", "slug", "types", "updateStatus", "updatedAt" FROM "Pokemon";
DROP TABLE "Pokemon";
